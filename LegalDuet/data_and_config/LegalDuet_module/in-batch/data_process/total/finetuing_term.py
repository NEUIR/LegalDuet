...
with open('finetuned_term_losses.txt', 'a') as f:
    for epoch in range(0, max_epoch):
        ...
        torch.save({'state_dict': legal_model.state_dict(), 'optimizer': optimizer.state_dict(), 'epoch': epoch + 1}, f"finetuned_term_model_epoch_{epoch+1}.pth.tar")
...
plt.savefig('finetuned_term_loss_curve.png')
plt.show()
